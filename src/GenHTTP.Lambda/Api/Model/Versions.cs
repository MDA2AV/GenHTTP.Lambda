...
/// <param name="Prompt">
/// What was asked for, in the words it was asked in - the request an agent was
/// answering, for example. Optional, and cut past 4000 characters.
/// </param>
/// <param name="Change">
/// What this version changes, in a line. Optional, and cut past 500 characters.
/// </param>
public sealed record VersionRequest(IReadOnlyList<LambdaFile>? Files, string? Prompt = null, string? Change = null);
...
/// <param name="Prompt">What was asked for, in the words it was asked in. Optional.</param>
...
public sealed record VersionChangeRequest(IReadOnlyList<LambdaFile>? Files, IReadOnlyList<string>? Remove, IReadOnlyList<FileEdit>? Edits,
                                          string? Prompt = null, string? Change = null);
...
public sealed record VersionResponse(int Version, DateTime Created, string? Prompt, string? Change, string? Origin);

/// <summary>
/// A version that was just stored.
/// </summary>
/// <param name="Prompt">What was asked for, as it was kept</param>
...
public sealed record SavedVersionResponse(int Version, DateTime Created, string? Prompt, string? Change, string? Origin,
...
public sealed record VersionContentResponse(int Version, DateTime Created, string? Prompt, string? Change, string? Origin,
